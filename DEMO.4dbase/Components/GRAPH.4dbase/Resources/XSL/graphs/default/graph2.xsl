...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="graph">
    ...
    <xsl:variable name="y_label_count" select="count(y_grid_values_relative/v)" />
    ...
    <xsl:variable name="y_max" select="number(settings/y_max/@relative)"/>
    <xsl:variable name="y_min" select="number(settings/y_min/@relative)"/>
